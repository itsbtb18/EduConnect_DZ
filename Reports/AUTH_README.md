# ILMI — Authentication & Admin Management
...
ILMI uses a **multi-tenant** architecture where each school is a tenant.
...
ILMI supports **multiple admin users per school**. This is the recommended setup for large schools.
