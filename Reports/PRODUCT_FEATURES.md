# EduConnect DZ — Complete Product Features Guide
...
The admin panel is used by the **school director, school admin, and section admins**. These are the people who chose to use EduConnect DZ. They expect a professional tool and they are comfortable with it.
...
If a parent has two or three children in the same school (or even different schools using EduConnect DZ), they switch between children profiles with one tap at the top of the screen. One app, one login, all children.
...
*EduConnect DZ — Product Specification Document*
